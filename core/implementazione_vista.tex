...
progettazione (Sezione~\ref{subsubsection:progettazione_lobby_frame}). Il primo
pannello peremtte agli utenti di scegliere il nome della stanza. Ha due bottoni,
...
\ref{figure:lobby_frame}, viene mostrato automaticamente non appena un host si
